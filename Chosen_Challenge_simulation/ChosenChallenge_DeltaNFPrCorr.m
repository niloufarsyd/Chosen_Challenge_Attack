...
%We run CMAES many times ("nCMAESRun" times) and check whether all APUF can be modeled or not
    ...
    NFP_Corr = zeros(nTrain,nXOR);
    Delta_Corr = zeros(nTrain,nXOR);
    Delta_Corr_abs = zeros(nTrain,nXOR);
    Delta=zeros(nTrain,nXOR);
    Delta_abs=zeros(nTrain,nXOR);
...
NFP1='NFPr.mat';
save(NFP1,'nonFlippingProbability');

Delta1='Delta.mat';
save(Delta1,'Delta');

Delta_abs1='Delta_abs.mat';
save(Delta_abs1,'Delta_abs');
% for g3=1:nXOR
