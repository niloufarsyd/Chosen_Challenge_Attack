...
nXOR_selected = 3;%define number of n here
k1 = 1; %if convert_xor is set to 1, it XORs k1 PUF to k2 PUF as one XOR PUF and save it in Av
k2 = 15;
bit_separation = [K-1, 1]; %separate a demical response vector into how many bits 

rawRespFile = [iDir 'chosen_responses75293.mat'];
rawRespFile2 = [iDir 'new_chosen_responses2.mat'];
...
if (APUF == 1)
    ...
    for i=1:nMeas
        ...
        A(:,:,i) = arrayToBinVec_a(resp_i,bit_separation);
    end
