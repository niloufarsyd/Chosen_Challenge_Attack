function [lambda,wModel] = CMAES1(W_real,Phi0,Phi1,nXOR,nSamples,ChalSize,sig,sigmaNoise,Size)
...
% --------------------  Initialization --------------------------------  
  ...
  strfitnesfct = 'modelAcc_rel_du1';  % name of objective/fitness function
  N = Size;               % number of objective variables/problem dimension
  xmean = rand(N,1);    % objective variables initial point
  sigma = 0.5;          % coordinate wise standard deviation (step size)
  stopfitness = 1e-10;  % stop if fitness < stopfitness (minimization)
  stopeval = 30000; %1e3*N^2;   % stop after stopeval number of function evaluations
  ...
  while counteval < stopeval
    ...
    for k=1:lambda,
      ...
      arfitness(k) = feval(strfitnesfct, (arx(:,k)),W_real,Phi0,Phi1,nXOR,nSamples,ChalSize,sig,sigmaNoise); % objective function call
